...
#include "process_msgs/msg/detail/cube__rosidl_typesupport_fastrtps_c.h"
...
using _Cube__ros_msg_type = process_msgs__msg__Cube;
...
size_t get_serialized_size_process_msgs__msg__Cube(
  ...
  size_t current_alignment)
{
  const _Cube__ros_msg_type * ros_message = static_cast<const _Cube__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = process_msgs__msg__Cube;
    is_plain =
      (
...
static bool _Cube__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const process_msgs__msg__Cube * ros_message = static_cast<const process_msgs__msg__Cube *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_process_msgs__msg__Cube(ros_message, cdr);
}

static bool _Cube__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  process_msgs__msg__Cube * ros_message = static_cast<process_msgs__msg__Cube *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_process_msgs__msg__Cube(cdr, ros_message);
}

static uint32_t _Cube__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_process_msgs__msg__Cube(
      untyped_ros_message, 0));
}

static size_t _Cube__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_process_msgs__msg__Cube(
...
static message_type_support_callbacks_t __callbacks_Cube = {
  "process_msgs::msg",
  "Cube",
  _Cube__cdr_serialize,
  _Cube__cdr_deserialize,
  _Cube__get_serialized_size,
  _Cube__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _Cube__type_support = {
