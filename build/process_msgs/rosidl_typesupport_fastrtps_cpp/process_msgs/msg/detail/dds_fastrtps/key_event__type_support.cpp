...
#include "process_msgs/msg/detail/key_event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const process_msgs::msg::KeyEvent & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: active_keys
  {
    cdr << ros_message.active_keys;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  process_msgs::msg::KeyEvent & ros_message)
{
  // Member: active_keys
  {
    cdr >> ros_message.active_keys;
  ...
  size_t current_alignment)
{
  ...
  // Member: active_keys
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.active_keys[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = process_msgs::msg::KeyEvent;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_process_msgs
max_serialized_size_key_KeyEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const process_msgs::msg::KeyEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<process_msgs::msg::KeyEvent *>(
    untyped_ros_message);
...
{
  return &process_msgs::msg::typesupport_fastrtps_cpp::_KeyEvent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, process_msgs, msg, KeyEvent)() {
  return &process_msgs::msg::typesupport_fastrtps_cpp::_KeyEvent__handle;
}
