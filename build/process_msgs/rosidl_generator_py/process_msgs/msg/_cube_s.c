...
bool process_msgs__msg__cube__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("process_msgs.msg._cube.Cube", full_classname_dest, 27) == 0);
  }
  process_msgs__msg__Cube * ros_message = _ros_message;
  {  // color
...
{
  /* NOTE(esteve): Call constructor of Cube */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("process_msgs.msg._cube");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Cube");
