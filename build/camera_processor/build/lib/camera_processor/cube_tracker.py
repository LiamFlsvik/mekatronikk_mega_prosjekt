...
class CubeTracker(Node):
    ...
    def __init__(self):
        ...
        self.color_ranges = { # Splitter ny
            'red':   {'hmin': 126, 'smin': 83, 'vmin': 55, 'hmax': 179, 'smax': 184, 'vmax': 255},
            'blue':  {'hmin': 103, 'smin': 117, 'vmin': 0, 'hmax': 169, 'smax': 180, 'vmax': 255},
            'yellow': {'hmin': 3, 'smin': 61, 'vmin': 0, 'hmax': 39, 'smax': 255, 'vmax': 255},
            'green': {'hmin': 30, 'smin': 36, 'vmin': 19, 'hmax': 93, 'smax': 120, 'vmax': 138},
        }
