...
#include "process_msgs/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const process_msgs::msg::Task & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  process_msgs::msg::Task & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = process_msgs::msg::Task;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const process_msgs::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<process_msgs::msg::Task *>(
    untyped_ros_message);
...
{
  return &process_msgs::msg::typesupport_fastrtps_cpp::_Task__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, process_msgs, msg, Task)() {
  return &process_msgs::msg::typesupport_fastrtps_cpp::_Task__handle;
}
