...
static const _Cube_type_support_symbol_names_t _Cube_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, process_msgs, msg, Cube)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, process_msgs, msg, Cube)),
  }
};
...
{
  return &::process_msgs::msg::rosidl_typesupport_cpp::Cube_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, process_msgs, msg, Cube)() {
  return get_message_type_support_handle<process_msgs::msg::Cube>();
}
