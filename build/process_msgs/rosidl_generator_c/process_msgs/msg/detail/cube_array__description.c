...
static char process_msgs__msg__CubeArray__FIELD_NAME__cubes[] = "cubes";

static rosidl_runtime_c__type_description__Field process_msgs__msg__CubeArray__FIELDS[] = {
  {
    {process_msgs__msg__CubeArray__FIELD_NAME__cubes, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription process_msgs__msg__CubeArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {process_msgs__msg__CubeArray__FIELDS, 1, 1},
    },
    {process_msgs__msg__CubeArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = process_msgs__msg__Cube__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *process_msgs__msg__CubeArray__get_individual_type_description_source(NULL),
    sources[1] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[2] = *process_msgs__msg__Cube__get_individual_type_description_source(NULL);
    constructed = true;
  }
